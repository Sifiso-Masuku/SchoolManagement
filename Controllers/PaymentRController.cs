...
{
    public class PaymentRController : Controller
    {
        ...
        {
            var application = db.ResidenceApplications.Find(id);
            ...
            onceOffRequest.amount = (double)application.RegistrationFee;
