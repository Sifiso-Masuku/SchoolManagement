    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> TeacherRegister(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                teacher.Gender = model.Gender.ToString();
                teacher.NID = model.NID;
                ...
                if (result.Succeeded)
                {
                    ...
                    var body = $"Hello {model.Name}, Nqabakazulu Comphrehesive High School has created an account on your behalf as a Teacher. <br/><br/>Your login credentials are as follows<br/><br/>" +
                    ...
                    emailService.SendEmail(new EmailContent()
                    {
                        ...
                        mailBody = body,
                        mailFooter = "<br/> Kind Regards, <br/> <b>Nqabakazulu Comphrehesive High School</b>",
                    ...
                    UserManager.AddToRole(user.Id, "Teacher");
                    return RedirectToAction("Index", "Teachers");/*/*("Register", "Account");*/
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                guardian.Surname = model.Surname;
                guardian.NID = model.NID;
                guardian.Phone = model.Phone;
                guardian.Email = model.Email;
                guardian.HomeAddress = model.HomeAddress;
                ...
                if (result.Succeeded)
                {
                    ...
                    // var callbackUrl = Url.Action("ConfirmEmail", "Account", new { userId = user.Id, code = code }, protocol: Request.Url.Scheme);
                    // await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
                    UserManager.AddToRole(user.Id, "Guardian");
                    return RedirectToAction("Index", "Guardians");/*/*("Register", "Account");*/
                }
                AddErrors(result);
            }
